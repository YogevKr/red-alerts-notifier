  ...
  it("renders compact bot status", () => {
    assert.equal(
      ...
      [
        ...
        "primary: close",
        "fallback: open",
        "telegram: ok checked_at=2026-03-24T12:00:10.400Z",
        "telegram_last_chat: telegram:1",
        "poll: ok errs=0 last_ok=2026-03-24T12:00:09.000Z",
        "db: ok latency_ms=3 checked_at=2026-03-24T12:00:10.500Z",
        ...
        "oref_alerts: ok fails=0 last_ok=2026-03-24T12:00:09.000Z",
        "oref_history: fail fails=2 last_ok=2026-03-24T11:59:55.000Z",
        "oref_history_error: timeout",
        "tzevaadom: connected recv=11 alerts=4 errs=0",
        "tzevaadom_last_message_at: 2026-03-23T11:48:03.890Z",
        "tzevaadom_last_alert_at: 2026-03-23T11:48:03.891Z",
      ].join("\n"),
    );
  });
